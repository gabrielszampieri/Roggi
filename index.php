...
<body>
    ...
    <main>
        ...
        <section class="section_1">
            <div class="div_1">
                <p class="paragraph_1">o ROGGi vem com a intenção de revolucionar o mercado de prestação autônoma de
                    serviços</p>
            </div>

            <div class="div_1">
                <div class="grid_3">
                    <img onclick="imgServicos()" class="img_grid" src="assets\2.png" loading="lazy" alt="" />
                    <img onclick="imgServicos()" class="img_grid" src="assets\1.png" loading="lazy" alt="" />
                    <img onclick="imgServicos()" class="img_grid" src="assets\3.png" loading="lazy" alt="" />
                </div>
            </div>
        </section>
        ...
        <section class="section_1">
            <div class="div_1">
                <div class="grid_4">
                    <img onclick="imgServicos()" class="img_grid" src="assets\post1.png" loading="lazy" alt="" />
                    <img onclick="imgServicos()" class="img_grid" src="assets\post2.png" loading="lazy" alt="" />
                    <img onclick="imgServicos()" class="img_grid" src="assets\post3.png" loading="lazy" alt="" />
                    <img onclick="imgServicos()" class="img_grid" src="assets\post4.png" loading="lazy" alt="" />
                </div>

            </div>
            <div class="div_1">
                <p class="paragraph_1">o ROGGi é uma empresa que tem como objetivo facilitar a vida de pessoas que
                    precisam de serviços domésticos de qualidade e praticidade</p>
            </div>
        </section>
