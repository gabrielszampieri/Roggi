<html lang="pt-BR">
    ...
    <main>
        ...
        <section class="section_1" id="sobre_column">
            ...
            <div class="div_1" id="sobre_column">
                ...
                <div class="div_2" id="sobre_div"></div>
                    ...
                    <div class="grid_3" id="sobre_grid">
                        <div onclick="henry()">
                            <img class="img_grid" src="assets\henrique.jpg" alt="Henrique"/>
                            <figcaption class="sobre_img">Henrique Guissoni</figcaption>
                        </div>
                        <div onclick="joao()">
                            <img class="img_grid" src="assets\jp.jpg" alt="João Pedro"/>
                            <figcaption class="sobre_img">João Guimenes</figcaption>
                        </div>
                        <div onclick="mari()">
                            <img class="img_grid" src="assets\mari.jpg" alt="Mariana"/>
                            <figcaption class="sobre_img">Mariana Vitória</figcaption>
                        </div>
                    </div>
                </div>
        ...
        <!-- <section class="section_1" id="contato">
            <div class="div_2">
                <h2 class="sobre_h2">
                    contato
                </h2>
